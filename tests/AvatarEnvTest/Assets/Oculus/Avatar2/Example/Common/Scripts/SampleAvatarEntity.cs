...
#pragma warning restore CS0414
    ...
    private void LoadLocalAvatar()
    {
        ...
        foreach (var asset in _assets)
        {
            ...
            int rnd_avatar = rnd.Next(33);

            path[0] = rnd_avatar + assetPostfix;
            if (isFromZip)
            {
                print(path);
                //print("hi");
                LoadAssetsFromZipSource(path);
                print("Loading Local Avatar test");
            }
            else
            {
...
#pragma warning restore 618 // restore deprecated method call warnings
    ...
    private void UserHasNoAvatarFallback()
    {
        OvrAvatarLog.LogError(
            $"Unable to find user avatar with userId {_userId}. Opening Avatar Editor.", logScope, this);
    ...
    private IEnumerator Retry_HasAvatarRequest()
    {
        ...
        do
        {
            ...
            switch (hasAvatarRequest.Result)
            {
                ...
                case OvrAvatarManager.HasAvatarRequestResultCode.HasNoAvatar:
                    ...
                    OvrAvatarLog.LogDebug(
                        "User has no avatar. Please open the Avatar Editor."
                        , logScope, this);
                    break;
            ...
            attempts++;
            UnityEngine.Debug.Log($"attemps: {attempts}");
        ...
        */
        //UnityEngine.Debug.Log("´ú¸ÕautoCheckChanges: \n" + _autoCheckChanges);
        //UnityEngine.Debug.Log("´ú¸ÕhasFoundAvatar: \n" + hasFoundAvatar);
        //UnityEngine.Debug.Log("´ú¸ÕHasLocalAvatarConfigured: \n" + HasLocalAvatarConfigured);

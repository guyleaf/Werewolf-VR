...
IL_011e:
	{
		...
		NullCheck(L_29);
		WitConfiguration_t3D1E7D46065A2742877307705778E1CBC33530DD* L_30 = ((WitRuntimeConfiguration_t74ABC500731591BA8D99A1C88E1821020551D3B3*)L_29)->___witConfiguration_0;
		NullCheck(L_30);
		String_t* L_31;
		L_31 = WitConfiguration_get_WitApplicationId_m6634CD56C438E238FC8619A3AF08F33733D0F0B1(L_30, NULL);
		NullCheck(L_28);
		InterfaceActionInvoker1< String_t* >::Invoke(5 /* System.Void Oculus.Voice.Core.Bindings.Interfaces.IVoiceSDKLogger::set_WitApplication(System.String) */, IVoiceSDKLogger_t8A0710A01D6E9FAA8D2FFE4190C3BD848CA655C0_il2cpp_TypeInfo_var, L_28, L_31);
		// _voiceSDKLogger.ShouldLogToConsole = enableConsoleLogging;
		RuntimeObject* L_32 = __this->____voiceSDKLogger_9;
		bool L_33 = __this->___enableConsoleLogging_7;
		NullCheck(L_32);
		InterfaceActionInvoker1< bool >::Invoke(3 /* System.Void Oculus.Voice.Core.Bindings.Interfaces.IVoiceSDKLogger::set_ShouldLogToConsole(System.Boolean) */, IVoiceSDKLogger_t8A0710A01D6E9FAA8D2FFE4190C3BD848CA655C0_il2cpp_TypeInfo_var, L_32, L_33);
		// OnInitialized?.Invoke();
		Action_tD00B0A84D7945E50C2DFFC28EFEE6ED44ED2AD07* L_34 = __this->___OnInitialized_10;
